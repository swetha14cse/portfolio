...
// const leadership = [
//   "Vice President – HACKERZ Technical Club",
//   "Led and coordinated major technical symposium events",
//   "Managed event planning, team coordination, and technical competitions"
// ];

// const volunteering = [
//   "Active member of Rotaract Club of Chennai",
//   "Participated in community service and leadership initiatives"
// ];
...
import { useState } from 'react';
import { Trophy, Users, Music, Heart, Crown, ChevronLeft, ChevronRight } from 'lucide-react';
import { motion } from 'framer-motion';
    ...
    <section id="achievements" className="py-20 bg-slate-50">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Recognition for technical excellence, leadership, community service, and creative performance
          </p>
        </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="w-full h-full bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-white/70 text-lg">
                      {achievementCarousel[currentAchievementIndex].title}
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="text-slate-600 mb-6 text-lg leading-relaxed">
                  {achievementCarousel[currentAchievementIndex].caption}
                </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Hackathons */}
          <motion.div
            className="bg-white rounded-2xl p-8 shadow-lg border-t-4 border-purple-600"
            variants={itemVariants}
            initial="hidden"
            whileInView="visible"
          >
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <Users className="w-8 h-8 text-blue-600" />
              <h3 className="text-xl font-bold">Event Organizing</h3>
            </div>

            <ul className="space-y-3">
              {eventOrganizing.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </motion.div>
          ...
          {/* Volunteering */}
          <motion.div
            className="bg-white rounded-2xl p-8 shadow-lg border-t-4 border-red-500"
            variants={itemVariants}
            initial="hidden"
            whileInView="visible"
          >
