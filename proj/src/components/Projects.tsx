    ...
    <section id="projects" className="py-20 bg-slate-900">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            Projects showcasing web development, AI solutions, and full-stack applications
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="bg-slate-800 rounded-2xl p-10 border border-slate-700">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {projects[currentIndex].tech.map((tech, idx) => (
                <span
                  key={idx}
                  className="px-4 py-2 bg-slate-700 text-purple-300 rounded-full text-sm border border-purple-500/30"
                >
                  {tech}
                </span>
              ))}
          ...
          <button
            onClick={prevProject}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white/10 p-3 rounded-full"
          >
          ...
          <button
            onClick={nextProject}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white/10 p-3 rounded-full"
          >
